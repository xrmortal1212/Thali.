@extends('layout.headerfooter', ['title' => 'Content'])
...
<div class="modal fade" id="downloadStepsModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content text-dark">
      <div class="modal-header">
        <h5 class="modal-title">Project Setup & Installation Guide</h5>
      ...
      <div class="modal-body">
        ...
        <ol>
          <li>Download and install <a style="color:black;" href="https://www.apachefriends.org/" target="_blank">XAMPP</a>.</li>
          <li>If the download doesn’t start, try using any VPN extension.</li>
        </ol>

        <h6>2. Start Apache & MySQL</h6>
        <ol>
          <li>Open <strong>XAMPP Control Panel</strong>.</li>
          <li>Click <strong>Start</strong> on both <em>Apache</em> and <em>MySQL</em> modules.</li>
        </ol>

        <h6>3. Extract the Project Files</h6>
        <ol>
          <li>Extract the downloaded <code>.rar</code> file (from Thali).</li>
        </ol>

        <h6>4. Open the Project Folder</h6>
        <ol>
          <li>Navigate into the extracted project folder.</li>
        </ol>

        <h6>5. Open Command Prompt</h6>
        <ol>
          <li>Click in the folder’s <em>address bar</em>.</li>
          <li>Type <code>cmd</code> and press <strong>Enter</strong>.</li>
        </ol>

        <h6>6. Run Laravel Commands</h6>
        <ol>
          <li><strong>Clear Configuration Cache</strong>  
            <pre><code>php artisan config:clear</code></pre>
          </li>
          <li><strong>Clear Application Cache</strong>  
            <pre><code>php artisan cache:clear</code></pre>
          </li>
          <li><strong>Rebuild Configuration Cache</strong>  
            <pre><code>php artisan config:cache</code></pre>
          </li>
          <li><strong>Optimize Application</strong>  
            <pre><code>php artisan optimize</code></pre>
          </li>
          <li><strong>Run Database Migrations</strong>  
            <pre><code>php artisan migrate</code></pre>
          </li>
          <li><strong>Create Storage Link</strong>  
        ...
        <h6>7. Access the Admin Panel</h6>
        <ol>
          <li>Open your browser and go to:  
            <pre><code>http://127.0.0.1:8000/admin/signup</code></pre>
          </li>
        </ol>

        <h6>8. Customize the Website</h6>
        <ol>
          <li>From the admin panel, add items, edit pages, and customize layouts.</li>
          <li>After adding content, activate it to make changes visible on the website.</li>
        </ol>

        <p class="mt-3"><strong>That’s it! Your project should now be running locally.</strong></p>

        <!-- 🎥 Video Tutorial Section -->
        <div class="mt-4">
          <h6>Watch Step-by-Step Video Guide</h6>
       <div class="ratio" style="max-width: 100%; height: 380px; margin:auto; overflow:hidden; border-radius:10px;">
    <video class="w-100 h-100" style="object-fit: cover;" autoplay muted loop controls>
      <source src="http://localhost:8000/assets/videos/guide.mp4" type="video/mp4">
            ...
            <div class="col-12 col-md-6 col-lg-6">
                <div class="row rating">
                    ...
                    <div class="col-6 progess-sec">
                        @foreach ([90, 50, 30, 10, 5] as $i => $value)
                            <div class="skill-row {{ $i == 4 ? 'd-none d-md-none d-lg-flex' : '' }}">
                                <div class="stars">
                                    <i class="fa-solid fa-star"></i>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" data-value="{{ $value }}"></div>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="testimonial p-3">
                                ...
                                <img src="{{ asset('assets/images/customer2.png') }}" class="sec-slider img-fluid" alt="Customer 2"><br><br>
                            </div>
                        </div>
                        ...
                        <div class="carousel-item">
                            <div class="testimonial p-3">
                                ...
                                <p>Lorem, nisi ipsam alias quasi aliquid eaque natus doloribus, maxime nulla ullam illum! Ex quibusdam esse enim dignissimos blanditiis error sunt eos.</p>
                                <img src="{{ asset('assets/images/customer1.png') }}" class="sec-slider img-fluid" alt="Customer 1"><br><br>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid content-cards">
        ...
        <div class="row m-4 mb-5">
            <div class="col-12 col-md-6 col-lg-3 content-card-1">
                <img src="{{ asset('assets/images/restoran.PNG') }}" class="img-fluid" alt="Restoran Theme">
            ...
            <div class="col-12 col-md-6 col-lg-3 content-card-1">
                <img src="{{ asset('assets/images/food.PNG') }}" class="img-fluid" alt="Food Mart Theme">
            ...
            <div class="col-12 col-md-6 col-lg-3 content-card-1">
                <img src="{{ asset('assets/images/lounge.PNG') }}" class="img-fluid" alt="Lounge Cafe Theme">
            ...
            <div class="col-12 col-md-6 col-lg-3 content-card-1">
                <img src="{{ asset('assets/images/Kelly.PNG') }}" class="img-fluid" alt="Kelly Portfolio Theme">
...
function renderTemplate(t) {
  ...
  // ✅ Images update
  document.querySelector(".main-img-1").src = t.cimg1 || "{{ asset('assets/images/std.PNG') }}";
  document.querySelector(".main-img-2").src = t.cimg2 || "{{ asset('assets/images/furni.PNG') }}";
  document.querySelector(".main-img-3").src = t.cimg3 || "{{ asset('assets/images/crypgo.PNG') }}";
  document.querySelector(".thumb-1").src = t.cimg1 || "{{ asset('assets/images/std.PNG') }}";
  document.querySelector(".thumb-2").src = t.cimg2 || "{{ asset('assets/images/furni.PNG') }}";
  document.querySelector(".thumb-3").src = t.cimg3 || "{{ asset('assets/images/crypgo.PNG') }}";
...
document.getElementById("mainDownload").addEventListener("click", function (e) {
  ...
  let stepsModal = new bootstrap.Modal(document.getElementById("downloadStepsModal"));
  setTimeout(() => {
    stepsModal.show();
  }, 800); 
});
