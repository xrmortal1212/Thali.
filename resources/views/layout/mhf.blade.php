...
<body style="background-color: #111; box-sizing: border-box; margin: 0; padding: 0;">
                ...
                <div class="col-6 col-sm-8 col-lg-8">
                    <nav class="navbar navbar-expand-lg navbar-custom justify-content-center p-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('/') ? 'active' : '' }}" href="main">
                                        <i class="fa-solid fa-house nav-icon"></i> Home
                                    </a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle {{ request()->is('template*') ? 'active' : '' }}"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('about') ? 'active' : '' }}" href="/m-about">
                                        <i class="fa-solid fa-user nav-icon"></i> About
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('contact') ? 'active' : '' }}" href="/m-contact">
    ...
    <div id="move">
        @for ($i = 0; $i < 9; $i++)
            <div class="marque">
                ...
                <img src="{{ asset('assets/images/arrow-br.svg') }}" alt="arrow" />
            </div>
        @endfor
    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <small class="footer-copy">&copy; {{ date('Y') }} Thali. All rights reserved.</small>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script src="{{ asset('js/scroll-circle.js') }}"></script>
