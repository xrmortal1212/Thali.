      ...
      <div class="carousel-item active">
        <div class="row g-0 align-items-center">
          <div class="col-12 col-md-5 p-4 text-light">
            ...
            <h2>Pixova - Lite</h2>
            <p>Pixova Lite is a free one page WordPress theme for business and portfolio websites.</p>
            <a href="https://downloads.wordpress.org/theme/pixova-lite.2.0.3.zip" class="btn btn-pink me-2 mb-2">Download</a>
            <!-- Preview Button -->
            <button class="btn btn-dark me-2 mb-2 preview-btn"
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-url="https://colorlibhub.com/pixova-lite/">
              Preview
            </button>
          </div>
          <div class="col-12 col-md-7">
            <div class="carousel-img-container">
              <img src="assets/images/feature-home-3.PNG"
                class="img-fluid w-100" alt="Pixova">
...
>
  ...
  async function loadTemplates() {
    try {
      const res = await fetch("https://sheet2api.com/v1/a9HEzsdORWec/templatesdb");
    ...
    `<div class="marquee-card col-12 article-loop col-md-6 col-lg-4">
          <article class="card-modern temp-card position-relative overflow-hidden">
            ...
            <div class="card-body">
              ...
              <div class="card-meta">
                 <button class="btn-shine btn-shine-main"><span>${t.rating}</span></button>
...
<?php echo $__env->make('layout.headerfooter', ['title' => 'Templates'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rimsha\Downloads\Thali\resources\views/template.blade.php ENDPATH**/ ?>