    ...
    <div class="left-panel2" data-aos="fade-right" data-aos-duration="900" data-aos-easing="ease-out-cubic">
      <div class="panel-inner">
        <div class="right-inner">
          ...
          <form method="POST" action="<?php echo e(route('login')); ?>" class="signup-form" data-aos="fade-up" data-aos-duration="900" data-aos-delay="350">
            <?php echo csrf_field(); ?>

            <?php if(session('status')): ?>
              <div class="errors" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="400">
                <ul><li><?php echo e(session('status')); ?></li></ul>
              </div>
            <?php endif; ?>
            ...
            <div class="small-row gap-2" data-aos="fade-up" data-aos-duration="700" data-aos-delay="700">
              ...
              <a href="<?php echo e(route('signup')); ?>" class="link">Create an account</a>
            </div>
...
<?php echo $__env->make('layout.headerfooter', ['title' => 'Sign In'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rimsha\Downloads\Thali\resources\views\signin.blade.php ENDPATH**/ ?>