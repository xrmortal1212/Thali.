...
<body style="background-color: #111; box-sizing: border-box; margin: 0; padding: 0;">
            ...
            <div class="row align-items-center gx-2">
                ...
                <div class="col-6 col-sm-8 col-lg-8">
                    <nav class="navbar navbar-expand-lg navbar-custom justify-content-center p-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(request()->is('/') ? 'active' : ''); ?>" href="main">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(request()->is('about') ? 'active' : ''); ?>" href="/m-about">
                                        <i class="fa-solid fa-user nav-icon"></i> About
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link <?php echo e(request()->is('contact') ? 'active' : ''); ?>" href="/m-contact">
                ...
                <div class="col-12 col-lg-2 d-flex justify-content-end mt-2 mt-lg-0 btn-main">
                    <?php if(auth()->guard()->check()): ?>
                                    <div class="dropdown">
                                        <button class="btn g-btn dropdown-toggle d-flex align-items-center" type="button"
                                            id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                            <img src="<?php echo e(Auth::user()->profile_image
                        ? asset('uploads/profile_images/' . Auth::user()->profile_image)
                        : 'https://i.pinimg.com/736x/69/38/5f/69385f654f6fbfd44600c9ca7ba03ad0.jpg'); ?>"
                                                alt="Profile" class="rounded-circle avatar-md me-2"
                                                style="width:36px;height:36 px;object-fit:cover;">
                                            <span class="d-none d-lg-inline"><?php echo e(Auth::user()->name ?? 'Account'); ?></span>
                                        </button>

                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                                            <li><a class="dropdown-item" href="<?php echo e(route('profile')); ?>">Profile Settings</a></li>
                                            </li>
                                            <li>
            ...
            <div class="row text-center text-md-start p-3">
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled footer-links">
                        <li><a href="main" class="footer-link">Home</a></li>
                        <li><a href="template" class="footer-link">Templates</a></li>
                        <li><a href="m-contact" class="footer-link">Contact Us</a></li>
                        <li><a href="m-about" class="footer-link">About Us</a></li>
                    </ul>
                </div>
    ...
    <script src="<?php echo e(asset('js/scroll-circle.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\Rimsha\Downloads\Thali\resources\views\layout\mhf.blade.php ENDPATH**/ ?>