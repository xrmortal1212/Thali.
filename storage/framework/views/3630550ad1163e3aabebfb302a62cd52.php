...
<?php $__env->startSection('main-content'); ?>
  <div>
    ...
    <div class="heading text-center text-light">
      ...
      <p class="p-3" data-aos="fade-up" data-aos-delay="300">Our team of skilled professionals combines 
        expertise, creativity, and dedication to deliver outstanding results. With a focus on quality and 
        client
         satisfaction, we work together to provide solutions that inspire trust and ensure long-term success.</p>
    </div>
    <div class="container-fluid  p-3">
      ...
      <div style="border-radius: 20px;"
        class="col-12 col-md-6 col-lg-5 ms-0 ms-d-2 ms-lg-2 m-2 text-light d-flex  cards " >
        <div class="img">
    ...
    <h1 style="font-family: 'Machina';font-weight: 900;" class="mt-1 mt-lg-5 try-h1" >Try Thali With Your Team For Free..
    </h1>
...
<?php echo $__env->make('layout.headerfooter', ['title' => 'About Us'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rimsha\Downloads\Thali\resources\views/about.blade.php ENDPATH**/ ?>