  ...
  <div class="signup-card">
    ...
    <div class="right-panel d-flex justify-content-center align-item-center" data-aos="fade-left" data-aos-duration="900" data-aos-easing="ease-out-cubic" data-aos-delay="200">
      <div class="right-inner">
        ...
        <form method="POST" action="<?php echo e(route('register.post')); ?>" class="signup-form " data-aos="fade-up" data-aos-duration="900" data-aos-delay="350">
          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.headerfooter', ['title' => 'Sign Up'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rimsha\Downloads\Thali\resources\views\signup.blade.php ENDPATH**/ ?>